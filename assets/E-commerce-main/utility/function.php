...
function get_total_order($con){
	$n=mysqli_num_rows(mysqli_query($con,"select * from cours"));
	return $n;
}
...
function get_total_product($con){
	$n=mysqli_num_rows(mysqli_query($con,"select * from subcategories"));
	return $n;
}
...
function get_total_seller($con){
	$n=mysqli_num_rows(mysqli_query($con,"select * from wp_users where user_status = 1"));
	return $n;
}
